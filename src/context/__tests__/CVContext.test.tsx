...
describe('CVContext', () => {
  ...
  describe('Education Operations', () => {
    test('should add new education entry', () => {
      ...
      expect(result.current.cvData.education[0].degree).toBe('Bachelor of Science in Computer Science')
    })
  ...
  describe('Certification Operations', () => {
    test('should add new certification', () => {
      ...
      expect(result.current.cvData.certifications[0].name).toBe('AWS Certified Solutions Architect')
    })
