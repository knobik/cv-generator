...
export function CVProvider({ children }: { children: React.ReactNode }) {
  ...
  const updateWorkExperience = useCallback(
    (id: string, experience: Partial<WorkExperience>) => {
      setCvData((prev) => {
        const updated = {
          ...prev,
  ...
  const updateSkillCategory = useCallback(
    (id: string, category: Partial<SkillCategory>) => {
      setCvData((prev) => {
        const updated = {
          ...prev,
  ...
  const updateCertification = useCallback(
    (id: string, certification: Partial<Certification>) => {
      setCvData((prev) => {
        const updated = {
          ...prev,
  ...
  const updateLanguage = useCallback(
    (id: string, language: Partial<Language>) => {
      setCvData((prev) => {
        const updated = {
          ...prev,
  ...
  const updateInterest = useCallback(
    (id: string, interest: Partial<Interest>) => {
      setCvData((prev) => {
        const updated = {
          ...prev,
  ...
  const updateGDPRClause = useCallback(
    (gdprClause: Partial<GDPRClause>) => {
      setCvData((prev) => {
        const updated = {
          ...prev,
