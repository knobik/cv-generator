...
export function WorkExperienceSection() {
  ...
  const { cvData, addWorkExperience, updateWorkExperience, removeWorkExperience } = useCVData();
          ...
          {workExperience.map((exp, index) => (
            <div key={exp.id} className="border border-gray-200 rounded-lg p-4">
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-medium text-gray-900">{t('forms.experience.experienceNumber', { number: index + 1 })}</h3>
                <Button
                  variant="danger"
                  size="sm"
